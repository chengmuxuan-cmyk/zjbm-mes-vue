<template>
  ...
  <el-tabs v-model="activeName" class="margin-20" @tab-click="handleClick">
    ...
    <el-tab-pane label="控制属性" name="控制属性">
        <control-attributes :productId="route.params.productId"></control-attributes>
    </el-tab-pane>
  </el-tabs>
</template>
...
import ControlAttributes from "@/views/iiot/product/components/controlAttributes.vue";
