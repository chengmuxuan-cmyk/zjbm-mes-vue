...
<!--            </el-form-item>-->
        ...
        <el-table v-loading="loading" :data="pointList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="是否广播" align="center" prop="broadcast" width="80">
              <template #default="scope">
                <dict-tag :options="iiot_websocket_model_point_broadcast" :value="scope.row.broadcast"/>
              </template>
            </el-table-column>
...
<!--                </el-form-item>-->
              <el-form-item label="是否广播" prop="form.broadcast">
                <el-switch
                ...
                <el-form-item label="十六进制指令" prop="hexData">
                    <el-input v-model="form.hexData" placeholder="请输入十六进制指令，空格分隔" type="textarea" :rows="4" />
                </el-form-item>
...
const { iiot_modbus_model_point_data_type, iiot_websocket_model_point_broadcast } = proxy.useDict("iiot_modbus_model_point_data_type", "iiot_websocket_model_point_broadcast");
...
const data = reactive({
    ...
    rules: {
        ...
        broadcast: [{ required: true, message: "是否广播不能为空", trigger: "change" }],
        hexData: [{ required: true, message: "十六进制指令不能为空", trigger: "blur" }],
    }
});
