        ...
        <el-col :span="24">
          <el-card class="box-card" shadow="never">
            ...
            <div style="height: calc(100% - 30px);">
              <StationPie height="100%" :pie-data="pieData"></StationPie>
              <div></div>
            </div>
          </el-card>
        </el-col>
...
<!--                &lt;!&ndash; <el-radio-button label="day">当日</el-radio-button> &ndash;&gt;-->
...
<script setup>
import { countByProductType } from "@/api/iiot/product";
...
/** 按产品类型分组统计产品数量 */
function countByProductTypeFunc() {
  countByProductType().then(response => {
    pieData.value = response.data.map(item => {
      return {
